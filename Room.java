...
public class Room {
    ...
    private String tmtp_st(RoomType rm){
        return switch (rm) {
            case OFFICE -> "OFFICE";
            case MAJLIS -> "MAJLIS";
            case G_STUDY -> "G_STUDY";
            case S_CASES -> "S_CASES";
            case M_CASES -> "M_CASES";
            case L_CASES -> "L_CASES";
    ...
    private String eq_st(ArrayList <Equipment> rm){
        ...
        for (Equipment equipment : rm) {
            switch (equipment) {
                case SMART_BOARD -> ans += "SMART_BOARD";
                case WHITEBOARD -> ans += "WHITEBOARD";
                case COMPUTERS -> ans += "COMPUTERS";
                case PROJECTOR -> ans += "PROJECTOR";
                default -> {
                    return "NONE";
                }
            }
    ...
    ArrayList <Equipment> eq, boolean status){
        ...
        this.eq = eq != null ? eq : new ArrayList<>();
        this.status = status;
    }
